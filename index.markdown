...
<span style="color:white">.</span>
## **연혁**
- 2026년 산업통상자원부 '바이오산업기술개발(디지털헬스케어)' 사업 선정(참여, KEIT) 
- 2026년 과학기술정보통신부 '실세계 능동행동형 에이전틱 AI' 사업 선정(주관, IITP)
- 2026년 XR + 생성형 AI 기반 가상인간 실시간 대화 훈련/평가 시스템 개발(글로벌 빅테크 S사)
- 2025년 스마트공장 공급기업 역량 Level 2 인증
- 2025년 온프레미스 생성형 AI 솔루션 'Factory SimSimi' 인공지능 신뢰성 인증 진행(TTA)
- 2025년 영주시, 영천시 챗브레인 공급
- 2025년 영남권 제조업을 위한 생성형 AI 트랜스포메이션 과제 수주(테크OO, 성우하OO, 대지에OO)
...
- [<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/250px-Instagram_icon.png" width="16">인스타그램](https://www.instagram.com/hey_simsimi/) [<img src="https://upload.wikimedia.org/wikipedia/commons/0/09/X_%28formerly_Twitter%29_logo_late_2025.svg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original" width="16">X(구:트위터)](https://www.twitter.com/hey_simsimi)
****
